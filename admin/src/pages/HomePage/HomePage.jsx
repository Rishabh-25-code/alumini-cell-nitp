...
const HomePage = () => {
  ...
  return (
    <div className="flex justify-center items-center pt-24">
      <div className="mt-20">
        <h2 className="text-sky-500 text-center md:text-5xl text-4xl font-bold">
          Welcome to
        </h2>
        <h1 className="lg:text-7xl md:text-6xl text-5xl font-bold text-center bg-gradient-to-r from-sky-400 via-pink-500 to-gray-600 bg-clip-text text-transparent">
          Admin Portal
        </h1>
