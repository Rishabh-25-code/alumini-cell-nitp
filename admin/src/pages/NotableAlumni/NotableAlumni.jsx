...
const AlumniCard = ({ alum, refetch }) => {
  ...
  return (
    <div data-aos="fade-in" className='relative flex lg:flex-row md:flex-col flex-col lg:items-start items-center justify-start rounded-2xl shadow-lg border border-gray-800 bg-gray-950 lg:py-6 py-10 lg:gap-3 md:gap-3 gap-6 lg:px-4 px-5 lg:max-w-full max-w-[24rem] m-auto'>
      <button onClick={() => {
        if (window.confirm("Are you sure you want to delete this alumni?")) handleDelete();
      }} className='absolute top-5 right-5 text-rose-500 text-2xl cursor-pointer'>
        <FaTrash />
      </button>
