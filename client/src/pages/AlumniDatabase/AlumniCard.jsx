                ...
                <div className="text-sm font-medium flex-1">
...

                    {
                        ...
                        <p>
                            ...
                            <a target='_blank' className='text-sky-500' href={`tel:${person.phone}`}>{person.phone}</a>
                        </p>
                    }

                    {person.showEmail && <p>
                        <span className="text-gray-400">EmailId:</span>{" "}
                        <a target='_blank' className='text-sky-500' href={`mailto:${person.email}`}>{person.email}</a>
                    </p>}
