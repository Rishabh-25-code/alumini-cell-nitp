                ...
                <div className="page-shell relative z-10 -mt-8">
                    <div className='surface-card w-full md:px-6 px-4 relative flex flex-col md:gap-4 gap-3 items-center rounded-3xl py-6'>
                        ...
                        <div className="flex w-full justify-center items-center gap-5">
                            ...
                            }} className='bg-white lg:px-4 md:px-4 px-2 md:py-2.5 py-2 font-normal md:w-[10rem] w-[9rem] text-slate-700 border border-slate-200 rounded-xl'>
                        ...
                        <div className="flex flex-wrap items-center gap-3 justify-center pt-2">
                            <button onClick={() => {
                                setBranch(null);
                                changeParams("page", 1);
                            }} className={`border border-slate-200 font-semibold px-5 py-2 text-base rounded-full transition hover:border-sky-300 hover:bg-sky-50 hover:text-sky-900 ${branch === null ? 'bg-sky-700 hover:bg-sky-600 !text-white border-sky-700' : 'text-slate-700 bg-white'}`}>
                                All
                            </button>
                            {
