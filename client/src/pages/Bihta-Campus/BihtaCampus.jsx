...
const BihtaCampus = () => {
    return (
        <>
            ...
            <Heading heading="NIT Patna" heading1={"Bihta Campus"}></Heading>
            <div className="flex items-center flex-col justify-center gap-10">
                ...
                <div>
                    <h1 className="lg:text-3xl text-2xl px-4 font-bold text-center mb-8 text-sky-500">Architectural Plans of <span className="text-white">Bihta Campus</span></h1>
