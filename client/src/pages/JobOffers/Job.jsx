                                    ...
                                    <div className='pt-2'>
                                        ...
                                        <div className='flex gap-2 items-center'>
                                            <div className='w-10 h-10 rounded-full overflow-hidden flex items-center justify-center'>
                                                <img src={`https://fra.cloud.appwrite.io/v1/avatars/initials?name=${job.name.split(" ").join("+")}&width=80&height=80`} alt='User Profile' />
                                            </div>
                                            <div className='flex flex-col'>
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            const shareItem = {
                                                ...
                                                text: job.jobTitle,
                                                url: `https://alumini-nitp.vercel.app/job/${job.$id}`,
                                            }
                                            if (navigator.share) {
