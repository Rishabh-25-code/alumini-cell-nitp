...
const AlumniCard = ({ alum }) => {
    return (
        <div data-aos="fade-in" className='rounded-3xl shadow-lg bg-[#000000] bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:14px_24px] hover:bg-gray-950 border border-gray-900'>
