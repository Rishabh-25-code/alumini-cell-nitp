...
const CreateAlumniProfile = () => {
    ...
    return (
        <div className='bg-gray-900 relative lg:p-5 my-5 rounded-2xl'>
            {isPending ?
                    ...
                    <div className='p-2'>
                        ...
                        <div className='py-5 text-lg'>
                            <p className='font-medium text-sky-500'>
                                <span className='text-white'>{alumni.title}. {alumni.fname + " " + alumni.lname}</span>
                            </p>
                            <p className='text-sky-500 font-medium'>
                                {alumni.designation && alumni.designation} at {alumni.company && alumni.company}, {alumni.location && alumni.location}
                            </p>
                            <p className='py-3'>
                            ...
                            <p className='font-medium text-sky-500'>
                                Batch : <span className='text-white'>{alumni.batchEnd ? alumni.batchStart + "-" + alumni.batchEnd : alumni.batchStart}</span>
                            </p>
                            <p className='font-medium text-sky-500'>
            ...
            {!isPending && alumni && alumni.length === 0 && <form className='flex gap-3 flex-col' onSubmit={handleSubmit(onSubmit)}>
