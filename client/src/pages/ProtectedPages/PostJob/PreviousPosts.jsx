                    ...
                    <div>
                        {
                            post.status === 'reviewing' && (
                                <div className="flex justify-center items-center">
                                    <p className="text-yellow-600 text-sm font-bold py-1.5 px-3 rounded-full">Your Job post is under review. It will be published soon.</p>
                                </div>
                            )
                        }

                        {
                            post.status === 'published' && (
                                <div className="flex justify-center items-center">
                                    <p className="text-green-500 text-sm font-bold py-1.5 px-3 rounded-full">Your job post is published.</p>
                                </div>
                            )
                        }
