...
const TeamCard2 = ({img2, name2, detail2 }) => {
  return (
    <>
          ...
          <div data-aos="fade-up" className="text-center text-gray-500 dark:text-gray-400">
              <img data-aos="zoom-in" className="mx-auto mb-4 w-36 h-36 rounded-full" src={img2} alt="Bonnie Avatar"/>
              ...
              <ul className="flex justify-center mt-4 space-x-4">
                  <li>
                  <a href="www.linkedin.com" className='transition ease-in delay-50 text-pink-500 hover:text-pink-600 hover:scale-[110%]'>
              <FaLinkedin size={22} />
            </a>
                  </li>
                  <li>
